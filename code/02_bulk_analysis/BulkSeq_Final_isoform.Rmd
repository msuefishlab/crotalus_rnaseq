---
title: "C. atrox spinal cord bulk RNA-Seq data (isoform level) with alignment to C. tigris genome"
output: 
  html_document:
    toc: TRUE
...
library(stringr)
theme_set(theme_bw())
setwd('~/Desktop/boris_bulk_data/c_tigris_based/')
...
```{r, message=FALSE}
file_names<-list.files('~/Desktop/boris_bulk_data/c_tigris_based/',pattern="\\genes.results$")
files <- file.path('~/Desktop/boris_bulk_data/c_tigris_based', file_names)
